...
(function (root) {
  ...
  function detailTranches(base, config) {
    const rows = [];
    let debut = 0;
  ...
  if (typeof module !== 'undefined' && module.exports) module.exports = Calcul;
  else root.Calcul = Calcul;
